...
function blessify(data) {
    ...
    const body = Object.keys(data).reduce((i, c) => {
        const joinGames = data[c].map(function (a) {
            var time = a.time, host = a.host, visitor = a.visitor, score = a.score, hasGoal = a.hasGoal;
            const goal = hasGoal ? chalk_1.default.bold.yellow.bgBlue('GOAL') : '';
